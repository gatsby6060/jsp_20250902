	...
	<table>
		...
		%>
			<tr>
				...
				<td> 
					<%-- <a href = "Board-View.jsp?boardNo=<%= rs.getString("BOARDNO") %>"><%= rs.getString("TITLE") %> --%>
					<a href = "javascript:;" onclick="fnStuInfo(<%= rs.getString("STU_NO") %>)"> <%= rs.getString("STU_NAME") %>
